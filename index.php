...
<body>
  ...
  <section class="header">
    ...
    <h3 id="dept">Kennesaw State University Department of Information Technology </h3>
  </section>
              ...
              <div class="thumbnailND">
                ...
                <div>
                  <a href="project.php?projectID=<?php echo $results['Project_ID']; ?>" class="project_link">
                                                  ...
                                                  <?php echo '<br><strong>Progress Status:</strong><br>' . getPHRStatus($results['Progress']) ?>
